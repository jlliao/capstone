...
\thesistitle{Real-time Filtering for Multi-sensory SLAM Benchmarking} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr/Pr. Bruno \textsc{Bodin}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Jianglong \textsc{Liao}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
%This capstone would not have been possible without the support of my faculty, friends and family.

%We thank Dr. Bruno Bodin for his invaluable advice on every aspect of this project, as well as his eagerness in teaching and recommending additional sources of information. 

%Additionally, we would like to thank the suite mates of Elm College’s 21st floor and my mother for emotional support throughout the process.
